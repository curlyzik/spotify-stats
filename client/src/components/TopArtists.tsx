  ...
  if (error || isError) {
    return (
      <div className="p-6 rounded-lg bg-spotify-dark-gray shadow-lg text-center">
        ...
        <div className="py-10">
          <svg
            className="w-12 h-12 text-red-500 opacity-70 mx-auto mb-4"
  ...
  if (artists.length === 0) {
    return (
      <div className="p-6 rounded-lg bg-spotify-dark-gray shadow-lg text-center">
        ...
        <div className="py-10">
          <svg
            className="w-12 h-12 text-spotify-light-gray opacity-30 mx-auto mb-4"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          ...
          <p className="text-spotify-light-gray">
            No artist data available for {getTimeRangeDisplay().toLowerCase()}.
          </p>
        </div>
      </div>
    );
          ...
          >
            ...
            {artist.images && artist.images.length > 0 ? (
              ...
              <div className="w-16 h-16 min-w-16 bg-spotify-light-gray bg-opacity-20 rounded-full flex items-center justify-center">
                <svg
                  className="w-8 h-8 text-spotify-light-gray"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="flex-1 min-w-0">
              ...
              {artist.followers && (
                <div className="flex items-center mt-1">
                  <svg
                    className="w-3 h-3 text-spotify-light-gray mr-1"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
